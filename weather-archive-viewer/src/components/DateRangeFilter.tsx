        ...
        {(['day', 'week', 'month'] as const).map((range) => (
          <button
            ...
            className={`px-3 py-1 text-sm rounded-md transition-colors ${
              filters.startDate && filters.endDate && filters.minDate && filters.maxDate &&
              isQuickRangeActive(range, filters.startDate, filters.endDate, filters.minDate, filters.maxDate)
